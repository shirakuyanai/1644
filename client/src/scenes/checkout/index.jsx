        ...
        <div className="col-lg-7 ps-lg-5 pe-lg-5">
          <div className="ps-lg-5 pe-lg-3">
            ...
            <div className="form-floating">
              ...
              >
                <option selected value="address_1_id">
                  Address 1 (Name 1)
                </option>
            ...
            <div className="d-lg-flex">
              <div className="form-floating col-lg-6 pe-lg-2 mt-3">
                <input
                  type="text"
                  name="firstname"
                  className="form-control rounded p-0 m-0"
                  id="floatingInput"
            ...
            <div className="d-lg-flex justify-content-center mt-3">
              ...
              <div className="form-floating col-lg-6 ps-lg-1 mt-3 mt-lg-0 mb-0">
                ...
                <label className="ps-lg-3" for="floatingSelect">
                  Province
                </label>
              </div>
            </div>
            ...
            <div className="d-lg-flex justify-content-center mt-3">
              <div className="form-floating col-lg-6 pe-lg-2">
                <select
                  ...
                  aria-label="District"
                >
                  <option selected value="District 1">
                    District 1
                  </option>
            ...
            <div className="text-center d-lg-lex">
              ...
              <div>
                <a href="/cart" className="float-lg-start mt-3 mb-0">
                  <i className="fa-solid fa-angle-left me-3"></i>Return to cart
                </a>
              </div>
            </div>
            <br />
              ...
              <div className="col-3 d-flex p-0" style={{ width: 100 + 'px' }}>
                <h5
                  ...
                  style={{
                    ...
                    height: 21 + 'px',
                    paddingTop: 2 + 'px',
                    transform: 'translate(' + 71 + 'px, ' + -11 + 'px)',
                  }}
                >
                  1
                </h5>
